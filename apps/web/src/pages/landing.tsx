...
import PlayGroundCreationPopUp from '@/components/PlaygroundCreationPopup';
import { useState } from 'react';

export default function LandingPage() {
    const [pl_createPopup, setPl_createPopup] = useState(false)
    return (
        <div className="flex flex-col min-h-[100dvh]">
            <Navbar />
            <PlayGroundCreationPopUp isOpen={pl_createPopup} onClose={() => setPl_createPopup(false)} />
                        ...
                        <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
                            <div className="flex flex-col justify-center space-y-4">
                                ...
                                <div className="flex gap-4">
                                    <Button
                                        onClick={()=>setPl_createPopup(true)}
