        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Choose a meeting type to get started. Each type is optimized for different use cases and comes with pre-configured settings.
                    </DialogDescription>
                </DialogHeader>
                    ...
                    <div className="mt-6 p-4 border rounded-lg bg-gray-50">
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-2 justify-end">
                                ...
                                <Button onClick={handleSubmit} disabled={!meetingName.trim()}>
                                    Create Meeting
                                </Button>
                            </div>
                        </div>
